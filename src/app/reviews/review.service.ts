...
export class ReviewsService {
  ...
  addReview(rating: number, review: string, hospitallName: string, username: string) {
    const fullReview: Review = {id: null, rating: rating, review: review, hospitallName: hospitallName, username: username};
